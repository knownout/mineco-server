...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 12 2021 г., 10:45
...
(1, 'slavinskiy', '02f8864b4b752b18fe12eee925434e28', 'Славинский Александр Романович', 1),
...
CREATE TABLE `properties` (
  `property` varchar(32) NOT NULL COMMENT 'name of the property',
  `value` text COMMENT 'value of the property'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
('importantData', 'Important data content');
...
ALTER TABLE `properties`
  ...
  ADD UNIQUE KEY `properties_property_uindex` (`property`);
